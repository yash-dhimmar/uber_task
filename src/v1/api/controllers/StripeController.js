...
class StripeController {
  ...
  async createcustomer(req, res) {
    try {
      ...
      var firstName = decodedData.user.firstName
      var lastName = decodedData.user.lastName
      var email = decodedData.user.email
      var user_id = decodedData.user.user_id;
      var data = await StripeService.createcustomer(req.body, firstName, lastName, email, user_id)
